...
$lang = array_merge($lang, [
	...
	'ACP_MOT_HANGMAN_CLEAR_SCORE_CONFIRM'		=> 'Do you really want to reset the Hangman highscore?',
	'ACP_MOT_HANGMAN_SCORE_TABLE_CLEARED'		=> '<strong>Hangman Highscore resetted</strong>',
	'ACP_MOT_HANGMAN_HIGHSCORE_TABLE_CLEARED'	=> 'Highscore table cleared',
	'ACP_MOT_HANGMAN_CLEAR_FAME'				=> 'Delete items from „Hall of Fame“ table',
	'ACP_MOT_HANGMAN_CLEAR_FAME_EXPL'			=> 'Here all the years are listed for which the „Hall of Fame“ table does contain data. You can select from the selection field
													at the right side those years for which you want to delete that data (multiple selections possible while clicking and simultanously
													holding the `Ctrl` key). ALL data of the selected year(s) will be deleted (the players with the highest scores for the previous months
													and years are stored in other tables and will not be lost).',
	'ACP_MOT_HANGMAN_NO_FAME_YEARS'				=> 'No items to delete',
	'ACP_MOT_HANGMAN_CLEAR_FAME_ERROR'			=> 'You did not make a selection therefore deletion is impossible!',
	'ACP_MOT_HANGMAN_CLEAR_FAME_CONFIRM'		=> [
		1	=> 'Do you really want to delete all „Hall of Fame“ data for the selected year?',
		2	=> 'Do you really want to delete all „Hall of Fame“ data for the selected %1$d years?',
	],
