...
$lang = array_merge($lang, [
	...
	'ACP_MOT_HANGMAN_ENFORCE_TERM_EXP'			=> 'Wenn aktiviert, werden Spieler, bei denen das Verhältnis der Spielepunkte zu den Begriffseingabepunkten
													...
													So können Sie Spieler erziehen, die das Eingeben von Suchbegriffen vernachlässigen.<br>
	...
	'ACP_MOT_HANGMAN_RANK_LIMIT_EXP'			=> 'Hier können Sie auswählen wie viele Spieler in den Tabellen für den laufenden Monat und das laufende Jahr angezeigt werden sollen.',
	...
	'ACP_MOT_HANGMAN_EXTRA_POINTS_ENABLE_EXP'	=> 'Wenn Sie die Hangman-Spieler mit Extrapunkten für das Lösen ohne falsche Versuche belohnen möchten, können Sie das hier
	...
	'ACP_MOT_HANGMAN_TERM_LENGTH_EXP'			=> 'Hier können Sie die Mindestlänge des Suchbegriffes als Anzahl der mindestens notwendigen Buchstaben eingeben
	...
	'ACP_MOT_HANGMAN_POINTS_ENABLE_EXPL'		=> 'Wenn ein Punkte-System (z.B. ´Ultimate Points´) auf Ihrem Board installiert ist, werden die Punkte vom Hangman dem Spielekonto
	...
	'ACP_MOT_HANGMAN_UPLOAD_XML_EXP'			=> 'Hier können Sie eine lokal auf Ihrem PC gespeicherte xml-Datei mit Suchbegriffen und Kategorien auswählen,
													auf den Server hochladen und in die Tabelle mit den Suchbegriffen integrieren.<br>
													Als Ersteller werden dabei Sie eingetragen, d.h. Sie können diese Suchbegriffe nicht spielen. Außerdem erhalten
													Sie keine Punkte dafür gutgeschrieben.',
	'ACP_MOT_HANGMAN_UPLOAD'					=> 'Datei hochladen',
	'ACP_MOT_HANGMAN_ERROR'						=> 'Fehler!',
	'ACP_MOT_HANGMAN_SELECT_FILE'				=> 'Wählen Sie bitte zuerst eine Datei aus',
	...
	'ACP_MOT_HANGMAN_IMPORT_TABLE_EXP'			=> 'Wenn Sie diese Auswahl sehen, existiert in der Datenbank eine Tabelle mit Suchbegriffen, die Sie noch nicht
													in dieses Spiel importiert haben; dies können Sie durch Anklicken der Schaltfläche rechts tun.<br>
